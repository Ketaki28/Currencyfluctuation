    ...
    <tbody>
      <?php 
          ...
          foreach ($records as $row){
              ...
              echo '<form action = "cartDisplay" method="post">';
              echo '<input type="submit" name="submit" value="Add To Cart" class="btn btn-warning">  ';
              echo '<input type="hidden" name="proId'.$pro1.'" id="proId'.$pro1.'" value="'.$row->itemID.'">';
              echo '<input type="hidden" name="desc'.$pro1.'" id="desc'.$pro1.'" value="'.$row->iName.'">';
              echo '<input type="hidden" name="cost'.$pro1.'" id="cost'.$pro1.'" value="'.$row->cost.'">';
              echo '<input type="hidden" name="curr'.$pro1.'" id="curr'.$pro1.'" value="'.$row->currName.'">';
