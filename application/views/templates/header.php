        ...
        <a class="navbar-brand" href="#"><h4 id="heading">Currency Converter</h4></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
                <div class="navbar-nav">
                      ...
                      <a class="nav-item nav-link" href="<?php echo base_url();?>index.php/currencyConvertor/aboutUs"><b><h5>AboutUs</h5></b></a>
                      <a class="nav-item nav-link" href="<?php echo base_url();?>index.php/signup/index"><b><h5>SignUp</h5></b></a>
                </div>
            </div>
    </nav>